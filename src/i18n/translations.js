...
export const translations = {
  vi: {
    ...
    search: { active: 'Đang tìm:', clear: 'Xóa', noResults: 'Không tìm thấy kết quả phù hợp.' },
    hero: {
      badge: '{count} công cụ & ứng dụng · miễn phí',
      titleLine1: 'Mọi công cụ và ứng dụng bạn cần, ở một nơi.',
      sub: 'Từ tải video, chỉnh ảnh, đến các ứng dụng desktop hữu ích — dùng ngay trên web hoặc tải app về máy, không cần tìm ở nhiều nơi khác nhau.',
      searchPlaceholder: 'Tìm công cụ hoặc ứng dụng… ví dụ: “tải TikTok”, “nén PDF”, “ghi màn hình”',
      searchBtn: 'Tìm',
      popularLabel: 'Phổ biến:',
      tag1: 'tải video', tag2: 'nén ảnh', tag3: 'ghi màn hình', tag4: 'đổi định dạng file',
      quickLabel: '⚡ Hoặc dùng nhanh downloader bên dưới',
    },
    tools: {
  ...
  en: {
    ...
    search: { active: 'Searching:', clear: 'Clear', noResults: 'No matching results found.' },
    hero: {
      badge: '{count} tools & apps · free',
      titleLine1: 'Every tool and app you need, in one place.',
      sub: 'From downloading video and editing images to handy desktop apps — use them right on the web, or download the app. No need to look elsewhere.',
      searchPlaceholder: 'Search tools or apps… e.g. "download TikTok", "compress PDF", "screen record"',
      searchBtn: 'Search',
      popularLabel: 'Popular:',
      tag1: 'download video', tag2: 'compress image', tag3: 'screen record', tag4: 'convert file',
      quickLabel: '⚡ Or use the quick downloader below',
    },
    tools: {
  ...
  zh: {
    ...
    search: { active: '搜索中：', clear: '清除', noResults: '未找到匹配结果。' },
    hero: {
      badge: '{count} 个工具和应用 · 免费',
      titleLine1: '你需要的所有工具和应用，尽在一处。',
      sub: '从下载视频、编辑图片，到实用的桌面应用——直接在网页使用，或下载应用，无需四处寻找。',
      searchPlaceholder: '搜索工具或应用……例如：“下载TikTok”、“压缩PDF”、“屏幕录制”',
      searchBtn: '搜索',
      popularLabel: '热门：',
      tag1: '下载视频', tag2: '压缩图片', tag3: '屏幕录制', tag4: '转换文件',
      quickLabel: '⚡ 或使用下方的快速下载器',
    },
    tools: {
  ...
  ja: {
    ...
    search: { active: '検索中：', clear: 'クリア', noResults: '一致する結果が見つかりません。' },
    hero: {
      badge: '{count} 個のツール＆アプリ · 無料',
      titleLine1: '必要なツールとアプリが、すべてここに。',
      sub: '動画のダウンロードや画像編集から便利なデスクトップアプリまで——ウェブでそのまま使うか、アプリをダウンロードするだけ。他を探す必要はありません。',
      searchPlaceholder: 'ツールやアプリを検索…例：「TikTokをダウンロード」「PDFを圧縮」「画面録画」',
      searchBtn: '検索',
      popularLabel: '人気：',
      tag1: '動画ダウンロード', tag2: '画像圧縮', tag3: '画面録画', tag4: 'ファイル変換',
      quickLabel: '⚡ または下の簡易ダウンローダーを使用',
    },
    tools: {
  ...
  ko: {
    ...
    search: { active: '검색 중:', clear: '지우기', noResults: '일치하는 결과가 없습니다.' },
    hero: {
      badge: '{count}개 도구 & 앱 · 무료',
      titleLine1: '필요한 모든 도구와 앱을 한곳에서.',
      sub: '동영상 다운로드, 이미지 편집부터 유용한 데스크톱 앱까지 — 웹에서 바로 사용하거나 앱을 다운로드하세요. 다른 곳을 찾을 필요 없습니다.',
      searchPlaceholder: '도구나 앱 검색… 예: "틱톡 다운로드", "PDF 압축", "화면 녹화"',
      searchBtn: '검색',
      popularLabel: '인기:',
      tag1: '동영상 다운로드', tag2: '이미지 압축', tag3: '화면 녹화', tag4: '파일 변환',
      quickLabel: '⚡ 또는 아래 빠른 다운로더 사용',
    },
    tools: {
  ...
  es: {
    ...
    search: { active: 'Buscando:', clear: 'Borrar', noResults: 'No se encontraron resultados.' },
    hero: {
      badge: '{count} herramientas y apps · gratis',
      titleLine1: 'Todas las herramientas y apps que necesitas, en un solo lugar.',
      sub: 'Desde descargar videos y editar imágenes hasta apps de escritorio útiles — úsalas directo en la web o descarga la app, sin buscar en otro lado.',
      searchPlaceholder: 'Busca herramientas o apps… ej: "descargar TikTok", "comprimir PDF", "grabar pantalla"',
      searchBtn: 'Buscar',
      popularLabel: 'Popular:',
      tag1: 'descargar video', tag2: 'comprimir imagen', tag3: 'grabar pantalla', tag4: 'convertir archivo',
      quickLabel: '⚡ O usa el descargador rápido de abajo',
    },
    tools: {
  ...
  fr: {
    ...
    search: { active: 'Recherche :', clear: 'Effacer', noResults: 'Aucun résultat trouvé.' },
    hero: {
      badge: '{count} outils et applis · gratuit',
      titleLine1: 'Tous les outils et applis dont vous avez besoin, au même endroit.',
      sub: 'Du téléchargement de vidéos à la retouche d\'images, en passant par des applis de bureau utiles — utilisez-les directement sur le web ou téléchargez l\'appli, sans chercher ailleurs.',
      searchPlaceholder: 'Rechercher un outil ou une appli… ex : « télécharger TikTok », « compresser un PDF », « enregistrer l\'écran »',
      searchBtn: 'Rechercher',
      popularLabel: 'Populaire :',
      tag1: 'télécharger vidéo', tag2: 'compresser image', tag3: 'enregistrer écran', tag4: 'convertir fichier',
      quickLabel: '⚡ Ou utilisez le téléchargeur rapide ci-dessous',
    },
    tools: {
