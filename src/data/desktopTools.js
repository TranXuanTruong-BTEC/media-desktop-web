...
export const desktopTools = [
  {
    ...
    tagline: 'App tải video mạnh mẽ — hỗ trợ hàng trăm nguồn và không giới hạn.',
    description:
    ...
    features: [
      ...
      'Hỗ trợ hàng trăm nền tảng video phổ biến',
    ...
    featured: true,
    tags: ['media', 'download', 'video', 'tiktok', 'windows'],
  },
]
